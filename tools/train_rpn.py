...
# function: train a rpn using vehicle trainval dataset
# --------------------------------------------------------
...
def rpn_generate(queue=None, imdb_name=None, rpn_model_path=None, cfg=None,
    ...
    cfg.TEST.RPN_POST_NMS_TOP_N = 50  # limit top boxes after NMS
...
if __name__ == '__main__':
    os.remove('/home/jingao/vehicle-detection/py-faster-rcnn/data/cache/voc_2007_trainval_gt_roidb.pkl')
    args = parse_args()
    ...
    print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
    print 'Stage 1,train RPN (init from ImageNet model)'
    print '~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~'
